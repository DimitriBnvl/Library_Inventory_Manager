...
There is no code to write in this exercise (aside from possibly some tests).

If you have completed all five of the exercises so far (or even if you haven't), now is always a good time to reflect
...
to add or change features in the assessed part of assignment 3.  Likewise, if you haven't been doing so already, adding
unit tests, coming up with additional example inputs, or documenting the results of runs of the program
on existing or new sample inputs would be good practice, and may help you in the next stage of the assignment where you 
...
over and make sure they ask questions about why the code is the way it is.  This may be helpful for everyone involved.
